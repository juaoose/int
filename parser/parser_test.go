...
func TestResurnStatements(t *testing.T) {
	input := `
return 5;
return 10;
return 123;
...
func TestIdentifierExpression(t *testing.T) {
	...
	if len(program.Statements) != 1 {
		t.Fatalf("program has not enough statemtns. got=%d", len(program.Statements))
	}
...
func TestParsingPrefixExpressions(t *testing.T) {
	...
	for _, tt := range prefixTests {
		...
		if len(program.Statements) != 1 {
			t.Fatalf("number of statements didnt match, got=%d", len(program.Statements))
		}
